...
const Guidelines = () => {
  ...
  const html = `
<h1>${siteName} site guidelines</h1>
<p>
  For the purpose of keeping this place civil and friendly, ${siteName} will have certain
...
<p>
  ${siteName}, being a forum of forums, will naturally have two levels of moderation: site-wide
...
<ol>
  <li>
    <strong>No spam.</strong> Sharing anything you've created or done on ${siteName} is
    completely fine but please don't repeatedly share the same link or submit to irrelevant
    communities. And don't use ${siteName} solely for self-promotion.
  </li>
  <li>
...
<p>
  ${siteName} is a work in progress, and these rules are not set in stone. They may change in
