const PrivacyPolicyContent = () => {
  return (
    <main className="document">
      ...
      <p>
        When you sign up, we collect a username (required, 3–21 characters), password (encrypted with bcrypt), and a required email address. Display name, bio, and profile picture are optional. Your email address must be verified before you can post or comment, and it is never displayed publicly to other users. We also record the IP address and timestamp when your account is created, and optionally which neighborhood you're from (to provide geometric context for your profile).
      </p>
