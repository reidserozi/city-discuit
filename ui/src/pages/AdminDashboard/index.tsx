...
const SVGReports = (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      fill="none"
    />
    <path d="M12 6V12M12 16H12.01" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
  </svg>
);
...
function AdminDashboard() {
  ...
  // TODO: Use the Dashboard components in these files also
  //
  // And also, the SVGs in the dashboard of the modtools need changing.
  ...
  return (
    <Dashboard
      ...
      sidebarMenu={[
        ...
        { name: 'Reports', to: '/admin/reports', icon: SVGReports },
        ...
        { name: 'Analytics', to: '/admin/bss', icon: SVGAnalytics },
        {
          ...
          to: '/admin/new-community-requests',
          icon: SVGNewCommunityRequests,
        },
      ]}
    >
      <Switch>
