      ...
      >
        ...
        >
          <nav className="sidebar-list">
            ...
            <Link to="/map" className="sidebar-item with-image" onClick={handleClose}>
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            >
              ...
              >
                <path d="M0 0h24v24H0V0z" fill="none" />
                <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm-7-8c0-3.86 3.14-7 7-7s7 3.14 7 7-3.14 7-7 7-7-3.14-7-7z" />
              </svg>
